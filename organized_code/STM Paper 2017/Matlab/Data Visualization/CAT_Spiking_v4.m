...
Time = xlsread('../../Data/Spiking/Misc_Plasma/14492/Spiking_CAT_results_1','Cohen_lab_06-24-14','A18:A137');
...
tA = title('A');
set(tA, 'FontSize',31, 'FontWeight', 'bold') %repeated again below
...
tB = title('B');
set(tB, 'FontSize',31, 'FontWeight', 'bold') %repeated again below
...
tC = title('C');
set(tC, 'FontSize',31, 'FontWeight', 'bold') %repeated again below
...
tE = title('E');
set(tE, 'FontSize',31, 'FontWeight', 'bold') %repeated again below
...
PredictedSystemplus = knpredict/(s^3 + k2predict*s^2 + k1predict*s + k0predict) * exp(-kdpredict*s);
PredictedTplus = linspace(0,50,501);
PredictedYplus = 5*impulse(PredictedSystemplus,PredictedTplus);
...
tF = title('F');
set(tF, 'FontSize',31, 'FontWeight', 'bold') %repeated again below
...
PredictedTplus = linspace(0,55,551);
PredictedYplus = 5*impulse(PredictedSystemplus,PredictedTplus);
...
tG = title('G');
set(tG, 'FontSize',31, 'FontWeight', 'bold') %repeated again below

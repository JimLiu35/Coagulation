...
SampleNormalCATTime = xlsread('../../Data/Processed/CAT_Normals','Dynamic','A2:A121');
SampleNormalCATData = xlsread('../../Data/Processed/CAT_Normals','Dynamic','H2:H121')/1000;
...
SampleNormala0 = xlsread('../../Data/Processed/CAT_Normals','Fits','B8:B8');
SampleNormala1 = xlsread('../../Data/Processed/CAT_Normals','Fits','C8:C8');
SampleNormala2 = xlsread('../../Data/Processed/CAT_Normals','Fits','D8:D8');
SampleNormalb = xlsread('../../Data/Processed/CAT_Normals','Fits','E8:E8')/100;
SampleNormalT = xlsread('../../Data/Processed/CAT_Normals','Fits','F8:F8');
...
legend('Normal CAT Data','0.104t exp(-0.18t)','0.048t^2 exp(-0.35t)','SDO Generated Fit', 'Location', 'northeast')
title('G')

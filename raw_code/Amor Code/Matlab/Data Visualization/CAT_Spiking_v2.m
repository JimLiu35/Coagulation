...
legend('#14492 II = 77','#14492 II = 90','#14492 II = 101','#14492 II = 115','#14492 II = 124')
%axis([0 45 -0.02 0.12])
axis([0 45 -0.05 0.2])
box on
title('A')
...
legend('#14492 VIII = 90','#14492 VIII = 111','#14492 VIII = 168','#14492 VIII = 203','#14492 VIII = 330','#14492 VIII = 390','#14492 VIII = 506')
%axis([0 45 -0.02 0.17])
axis([0 45 -0.05 0.2])
box on
title('C')
...
legend('#14504 X = 76','#14504 X = 133','#14504 X = 178','#14504 X = 215','#14504 X = 280','#14504 X = 317')
axis([0 45 -0.05 0.35])
box on
title('E')

...
xlabel('{\itP} [\muM]')
ylabel('{\itT_P} [min]')
h_leg = legend([p1 p2],{'Normal','Trauma'},4);
...
%%
MCADataValues = xlsread('/Users/amenezes/Documents/Work/Research/Projects/Coagulation/2014/Data/Processed/CAT_Normals','Fits','B2:R21');
...
MCADataValues = xlsread('/Users/amenezes/Documents/Work/Research/Projects/Coagulation/2014/Data/Processed/CAT_Trauma','Fits','B2:R41');
...
tA = title('A');
legend('Low {\itT}','Med. {\itT}, Low {\it\omega_n}', 'Med. {\itT}, High {\it\omega_n}','High {\itT}',2)
...
axis([1.4 12 0.3 2.1])
tB = title('B');
legend('Low {\itT}','Med. {\itT}, Low {\it\omega_n}', 'Med. {\itT}, High {\it\omega_n}','High {\itT}',1)

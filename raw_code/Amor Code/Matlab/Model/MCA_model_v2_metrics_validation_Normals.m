function MCA_model_v2_metrics_validation_Normals
...
clf
subplot(2,1,1)
hist(AbsPercentErrorofPeak,5:10:145)
xlabel('Percent Error in Max. Thrombin Prediction')
ylabel('Frequency')
grid on
...
subplot(2,1,2)
hist(AbsPercentErrorTimeofPeak,5:10:35)
xlabel('Percent Error in Time of Max. Thrombin Prediction')
ylabel('Frequency')
grid on

function HockinMannModel_NormalsValidation
...
for VisualNum = 1:20
    ...
    StagoDataValues = xlsread('/Users/amenezes/Documents/Work/Research/Projects/Coagulation/2014/Data/Processed/CAT_Normals','Fits','G2:M21');
    CATDataValues = xlsread('/Users/amenezes/Documents/Work/Research/Projects/Coagulation/2014/Data/Processed/CAT_Normals','Dynamic','A2:Y121');
    ...
    elseif VisualNum < 16
        t = CATDataValues(:,13)*60;
        CATColIndex = VisualNum + 3;
    else
        t = CATDataValues(:,20)*60;
...
hist(MaxThrombinPercentError,5:10:95)
xlabel('Percent Error in Hockin-Mann Max. Thrombin Prediction')
ylabel('Frequency')
grid on
...
hist(TimeMaxThrombinPercentError,10:20:190)
%hist(TimeMaxThrombinPercentError,50:100:1150)
xlabel('Percent Error in Hockin-Mann Time of Max. Thrombin Prediction')
ylabel('Frequency')
grid on

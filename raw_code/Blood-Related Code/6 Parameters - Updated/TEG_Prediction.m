function [res,fit_param_factor_chosen,i_chosen, Factor_tag, fit_param_sorted] = TEG_Prediction(Coefficients,param)
...
Factor_tag={'II', 'V', 'VII' , 'VIII', 'IX', 'X', 'ATIII', 'PC' ,'Fib', 'D-dimer'};
...
for i=1:NumFac  %!!
    ...
    fit_param_sorted(i_chosen(i),1)=fit_param_factor_chosen(i+1); %sorts the factor coeff based on the factor_tag 
